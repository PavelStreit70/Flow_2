...
14.Facetovanie t-SNE premennou, ktorú si vyberieme, napr. použitím paramteru Docetaxel. Vidíme batch effect - je potrebná korekcia dát
...
#NaN = not a number...niečo je zle
```

23. Calculate MAD to estimate the loss of biological heterogeneity. 
